...
public class JoinedEventsTest {
    ...
    public void setUp() {
        ...
        intent.setClassName("com.example.eventmaster", JoinedEventsActivity.class.getName());
    ...
    //test "view my waitlists" button
    @Test
    public void testWaitlistButton() {
        onView(withId(R.id.view_waitlist_button)).perform(click());
        intended(hasComponent(WaitlistedEventsActivity.class.getName()));
    }
